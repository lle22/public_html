      ...
      <div class="register">
        ...
        <fieldset id="address">
          ...
          <div class="form-group required" style="display: none">
            ...
            <div class="col-sm-10">
            <?php if ($city) { ?>
              <input type="text" name="city" value="<?php echo $city; ?>" placeholder="<?php echo $entry_city; ?>" id="input-city" class="form-control" /><?php } else {?>
		...
		success: function(json) {
			...
			if (json['zone'] != '') {
				for (i = 0; i < json['zone'].length; i++) {
					...
					//loile added start
					if (json['zone'][i]['zone_id'] == '3780' && json['zone'][i].country_id == '230' && '<?php echo $zone_id; ?>' == '') {
						html += ' selected="selected"';
						$('#input-city').val(json['zone'][i]['name']);
                                                $('#input-postcode').val(json['zone'][i]['zone_id']);   
					} else //LOILE added end
