  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <div class="panel panel-default">
        <div class="panel-body">
          <div class="row">
            ...
            - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -<br />
            <span style="font-weight:bold; color:#FF0000; font-size:14px;">Vietin</span>
	  ...
	  <br>
	   ...
	   <span style="font-size:14px; color:#F00; font-weight:bold;">59034869
	   </span>
	   </br>
            <!--Loi Add end-->
            </div>
            ...
            <div class="col-sm-3"><strong><?php echo $text_telephone; ?></strong><br>
              <span style="font-size:14px; color:#F00; font-weight:bold;"><?php echo $telephone; ?></span><br />
              <br />
              <?php if ($fax) { ?>
              <strong><?php echo $text_fax; ?></strong><br>
              <span style="font-size:14px; color:#F00; font-weight:bold;"><?php echo $fax; ?></span>
              <?php } ?>
              <br /><br/>
              <!--LOILE ADDED START-->
              <strong><?php echo $entry_email; ?></strong><br>
              <span style="font-size:14px; color:#F00; font-weight:bold;">phuongnam_vpp@yahoo.com, lka02@yahoo.com</span>
              <!--LOILE ADDED END-->
            </div>
            <div class="col-sm-3">
              <?php if ($open) { ?>
