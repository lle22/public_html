...
class ModelAccountCustomer extends Model {
	public function addCustomer($data) {
		...
		//LOILE comment $subject = sprintf($this->language->get('text_subject'), $this->config->get('config_name'));
                $subject = sprintf($this->language->get('text_subject'), $this->config->get('config_name'));
		$message = sprintf($this->language->get('text_welcome'), $this->config->get('config_name')) . "\n\n";

		if (!$customer_group_info['approval']) {
			$message .= sprintf($this->language->get('text_login'), $data['email'])  . "\n";
		} else {
		...
		//LELOI COMMENTED $message .= $this->config->get('config_name');
                //LOI ADDED START 
                $message .= $this->language->get('text_vpppn_daydu') . "\n";
                $message .= $this->language->get('text_address') . $this->config->get('config_address') . "\n";
                $message .= $this->language->get('text_telephone') . $this->config->get('config_telephone') . "\n";
                $message .= sprintf($this->language->get('text_email'), $this->config->get('config_email'),$this->config->get('config_email')) . "\n";
                $message .= $this->language->get('text_website');
		...
		$mail->setSender($this->config->get('config_name'));
                //LOILE COMMENTED $mail->setSender($this->language->get('text_vpppn'));
		$mail->setSubject($subject);
		//LOILE commented $mail->setText(html_entity_decode($message, ENT_QUOTES, 'UTF-8'));
                $mail->setHtml($message);
                //LOILE commented $mail->setText($message);
		$mail->send();
